...
const ErrorInformation: React.FC = () => {
  const config = {
    method: 'get',
    url: 'https://api.flutterwave.com/v3/transactions/4060994/verify',
    headers: {
      Authorization: 'Bearer FLWSECK_TEST-6c51a74763a921d57158b52e5629f55c-X',
    },
  };
  ...
  const backgroundThumbnail = 'https://hub.fanitehub.com/404-bg.png';
