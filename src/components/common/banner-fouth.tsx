import BannerThreeCard from '@components/cards/banner-three-card';
import Container from '@components/ui/container';
import useWindowSize from '@utils/use-window-size';
import Carousel from '@components/ui/carousel/carousel_ltr';
            ...
            {slideresponse?.map((item) => (
              ...
              >
                <BannerThreeCard
                  key={item._id}
                  collection={item}
                  href={`${ROUTES.SEARCH}?slug=${item.slug}`}
                />
              </SwiperSlide>
            ))}
          </Carousel>
